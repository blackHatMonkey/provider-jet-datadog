...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-datadog_v3.12.0_x5
export TERRAFORM_DOCS_PATH := website/docs/resources
...
xpkg.build.upjet-provider-datadog: do.build.images
